...
public class UberCar {
   ...
   public UberCar(boolean available, String brand, int manufactured_year, int min_seats, int max_seats, int serial_num, String model_num, String availble_city, boolean maintenance_certificate) {
